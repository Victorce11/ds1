# Exercício 05 - Operadores lógicos e validações
...
ingresso_resposta_valida = resposta_autorizacao in ("s", "sim", "n", "não", "não")
autorizacao_resposta_valida = resposta_autorizacao in ("s", "sim", "n", "não", "não")
